    ...
    <el-card class="box-card">
      ...
      <div>
        ...
        >
          ...
          <el-form-item label="采购核对状态" prop="delivery">
            <el-select v-model="ruleForm.region" style="width:600px" placeholder="请选择采购核对状态">
                ...
                <el-tabs v-model="activeName" @tab-click="handleClick">
                  <el-tab-pane label="内容" name="second">
                    <el-table :data="tableData" border style="width: 100%">
                      ...
                      <el-table-column prop="address" label="(未进数量)" width="140"></el-table-column>
                      <el-table-column prop="address" label="(采购订单号)" width="140"></el-table-column>
...
<el-dialog title="采购发票清单维护" :visible.sync="qingVisible">
  <!-- 采购入库单内嵌套窗口 -->
   ...
   <el-card class="box-card">
      采购入库单<el-input v-model="input" placeholder="请输入内容" style="width:150px"></el-input>-
        ...
        <el-button class="el-icon-view" style="width:60px"></el-button>
          <el-button type="primary" @click="innerVisible1 = true" class="el-icon-zoom-in" style="width:60px"></el-button> <br><br>
          采购退货单<el-input v-model="input" placeholder="请输入内容" style="width:150px"></el-input>-
        <el-input v-model="input" placeholder="请输入内容" style="width:150px"></el-input>
        <el-button class="el-icon-view" style="width:60px"></el-button>
          <el-button type="primary" @click="innerVisible2 = true" class="el-icon-zoom-in" style="width:60px"></el-button><br><br>
          折让确认单<el-input v-model="input" placeholder="请输入内容" style="width:150px"></el-input>-
        <el-input v-model="input" placeholder="请输入内容" style="width:150px"></el-input>
        <el-button class="el-icon-view" style="width:60px"></el-button>
          <el-button type="primary" @click="innerVisible3 = true" class="el-icon-zoom-in" style="width:60px"></el-button>
        </el-card>
 <el-table
      :data="tableData"
      style="width: 100%"
 ...
 <el-table-column prop="date" label="数量" sortable width="130"></el-table-column>
      ...
      <!-- 采购订单小窗口 -->
      <el-dialog title="采购订单转采购发票" :visible.sync="dialogVisible" width="50%" :before-close="handleClose">
         <el-dialog
      width="30%"
      title="多选--采购订单"
